...
require (
	...
	sigs.k8s.io/kubebuilder-declarative-pattern v0.15.0-beta.1.0.20231018044057-96dd7e16c1e2
)
...
require (
	...
	sigs.k8s.io/kubebuilder-declarative-pattern/applylib v0.0.0-20231018044057-96dd7e16c1e2 // indirect
